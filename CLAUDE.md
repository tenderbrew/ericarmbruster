...
- **The welcome line:** "Welcome to my personal roost." is a quiet link (`.quiet-door`) to now.html — now has no dock tile.
- **The doubloon:** a single gold pixel (`.doubloon`) floats in the masthead water and opens bitcoin.html — bitcoin has no dock tile either. Both open as windows like everything else.
